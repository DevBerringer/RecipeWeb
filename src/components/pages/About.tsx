      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center">
          <h2 className="text-3xl font-extrabold text-gray-900 sm:text-4xl">
            About Recipe Central
          </h2>
          <Croissant className="max-w-7xl mx-auto" />
        ...
        <div className="mt-10">
          ...
          <p className="mt-4 text-lg text-gray-500">
            ...
            explore their culinary creativity. We want to make cooking enjoyable
            and accessible for everyone, whether you are a seasoned chef or just
        ...
        <div className="mt-10">
          ...
          <p className="mt-4 text-lg text-gray-500">
            ...
            account, and you will be able to upload your recipes, complete with
            ingredients, step-by-step instructions, and mouthwatering photos.
            You can also browse through the extensive collection of recipes
            contributed by other users, leave comments, and save your favorite
            recipes for later.
          </p>
        </div>
        <div className="mt-10">
          ...
          <p className="mt-4 text-lg text-gray-500">
            ...
            simply enjoy trying out new recipes, Recipe Central is the place for
            you. Connect with like-minded individuals, share your culinary
        ...
        <div className="mt-10">
          ...
          <p className="mt-4 text-lg text-gray-500">
            ...
            to hear from you! You can reach out to our team through the contact
            form on our website, and we will get back to you as soon as
            possible.
          </p>
        </div>
      </div>
